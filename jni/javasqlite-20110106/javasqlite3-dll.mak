...
#
# Assumes that the SQLite DLL and header are in this directory
...
SQLite/Constants.java:	mkconst.exe VERSION
...
install:
	...
	copy $(SQLITE3_LIB) $(NATIVE_LIB_DIR)
